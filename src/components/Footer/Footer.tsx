  ...
  return (
    <footer id="footer" className=" bg-blue-100">
      <div className="container mx-auto p-5">
        <div className="bg-white border border-transparent rounded-lg flex items-center justify-evenly mt-6 p-6">
        ...
        <div className="flex justify-between mt-10">
          <div>
            ...
            <div className="border border-t-1 border-t-gray-500 mt-4 cursor-pointer">
          ...
          <div>
            ...
            <ul className="list-disc text-blue-900 leading-loose cursor-pointer">
